...
const Navbar = () => {
  ...
  const [isSicky, setIsSicky]=useState(false)
  useEffect(()=>{
    const handleScroll=()=>{
  ...
  return (
    ...
    container mx-auto fixed top-0 left-0 right-0
    transition-all duration-300 easy-in-out'>
        <div className={`navbar xl:px-24 ${isSicky ? "shadow-md bg-base-100 transition-all duration-300 easy-in-out" : " "}`}>
